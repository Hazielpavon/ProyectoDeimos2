...
struct qt_meta_stringdata_CLASSMinotaurENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMinotaurENDCLASS = QtMocHelpers::stringData(
    "Minotaur"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMinotaurENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Minotaur::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMinotaurENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMinotaurENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMinotaurENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Minotaur, std::true_type>
    >,
    nullptr
} };
...
void *Minotaur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMinotaurENDCLASS.stringdata0))
