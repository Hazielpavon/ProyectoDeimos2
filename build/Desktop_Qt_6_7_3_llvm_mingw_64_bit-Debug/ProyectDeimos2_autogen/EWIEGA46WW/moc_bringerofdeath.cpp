...
struct qt_meta_stringdata_CLASSBringerOfDeathENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSBringerOfDeathENDCLASS = QtMocHelpers::stringData(
    "BringerOfDeath",
    "onDeathAnimFinished",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSBringerOfDeathENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject BringerOfDeath::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSBringerOfDeathENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSBringerOfDeathENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSBringerOfDeathENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BringerOfDeath, std::true_type>,
        // method 'onDeathAnimFinished'
...
void *BringerOfDeath::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSBringerOfDeathENDCLASS.stringdata0))
