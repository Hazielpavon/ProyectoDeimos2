...
struct qt_meta_stringdata_CLASSMutantWormENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMutantWormENDCLASS = QtMocHelpers::stringData(
    "MutantWorm"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMutantWormENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MutantWorm::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMutantWormENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMutantWormENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMutantWormENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MutantWorm, std::true_type>
    >,
    nullptr
} };
...
void *MutantWorm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMutantWormENDCLASS.stringdata0))
